...
public class NoteSpecTest {
    ...
    public void testOctaves() throws Exception {
        ...
        n = new NoteSpec('c', 'n', 1, 4);
        n2 = new NoteSpec("c1");
        assertEquals("Should be Octave 1 C", n, n2);

        n = new NoteSpec('d', 'n', 7, 4);
        n2 = new NoteSpec("d7");
    ...
    public void testValue() throws Exception {
        ...
        n = new NoteSpec('c', 'n', 4, 8);
        n2 = new NoteSpec("c/8");
        assertEquals("Should be Middle C (60) eigth", n, n2);

        n = new NoteSpec('c', 'n', 4, 12);
        n2 = new NoteSpec("c/8.");
